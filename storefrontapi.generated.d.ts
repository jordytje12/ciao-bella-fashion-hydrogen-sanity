...
export type MenuProductsQueryVariables = StorefrontAPI.Exact<{
  query: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type MenuProductsQuery = {
  collections: {
    nodes: Array<
...
export type SanityModuleProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type SanityModuleProductsQueryVariables = StorefrontAPI.Exact<{
  productIds:
...
export type SanityModuleProductsQuery = {
  products: Array<
    StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        featuredImage?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  '#graphql\n  fragment MenuProductCard on Product {\n    id\n    title\n    handle\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n  query MenuProducts(\n    $query: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collections(first: 10, query: $query) {\n      nodes {\n        handle\n        products(first: 4) {\n          nodes {\n            ...MenuProductCard\n          }\n        }\n      }\n    }\n  }\n': {
    return: MenuProductsQuery;
    variables: MenuProductsQueryVariables;
  };
  '#graphql\n  fragment SanityModuleProduct on Product {\n    id\n    title\n    handle\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n\n  query SanityModuleProducts(\n    $productIds: [ID!]!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products: nodes(ids: $productIds) {\n      ... on Product {\n        ...SanityModuleProduct\n      }\n    }\n  }\n': {
    return: SanityModuleProductsQuery;
    variables: SanityModuleProductsQueryVariables;
  };
